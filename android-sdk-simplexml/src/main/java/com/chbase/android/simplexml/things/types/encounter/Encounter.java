...
package com.chbase.android.simplexml.things.types.encounter;
...
@Root(name = "encounter")
public class Encounter extends AbstractThing {
    public static String typeId = "464083cc-13de-4f3e-a189-da8e47d5651b";
    ...
    @Element(name = "consent-granted",required = false)
